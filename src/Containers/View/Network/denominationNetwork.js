		                        ...
		                        <div className="row justify-content-bewteen mt-5">
									<div className="col-md-3 col-lg-3">
			                            ...
			                            <div className="mt-5 bg-white p-3">
			                            	<p className="">
			                            		<a href="/" className="c-brand f-med f-14">Create a Group</a>
			                            	</p>
			                            	<p className="mb-0">
			                            		<a href="/" className="c-brand f-med f-14">Post a Topic</a>
			                            	</p>
			                            </div>
									</div>
									...
									<div className="col-md-3 col-lg-3">
			                            ...
			                            <section className="church-branches bg-white mt-4 p-2">
			                                ...
			                                <div className="branches mt-3">
			                                    ...
			                                    <div className="c-brand f-14 mt-3 f-med text-center mb-3">
