        ...
        <div className="User">
            ...
            <main>
                <div className="container mt-3 px-0">
                    <Tabs defaultActiveKey="flatform" className="bg-white" fill variant="tabs" transition={false} id="noanim-tab-example">
                        <Tab eventKey="network" title="Belivers’ Fellowship/Network">
                        ...
                        <Tab eventKey="flatform" title="Church Organisation Flatform">
                        ...
                        <Tab eventKey="devotional" title="Biblical Search/Devotional">
                            <div className="row mt-3 justify-content-center">
                                tab 3 content
                            </div>
                        </Tab>
                        <Tab eventKey="store" title="Online Store">
                            <div className="row mt-3 justify-content-center">
                                tab 3 content
                            </div>
                        </Tab>
                        <Tab eventKey="directory" title="Directry/Event Locator">
                            <div className="row mt-3 justify-content-center">
                                tab 3 content
                            </div>
                        </Tab>
                        <Tab eventKey="welfare" title="Welfare">
                            <div className="row mt-3 justify-content-center">
                                tab 3 content
                            </div>
                        </Tab>
